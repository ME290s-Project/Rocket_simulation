...
% problem description
R0 = zonotope([[0;0;0;0;0;0;5.5e5],diag([10;10;0;0;0;0;0])]);
lb = [-3;0.9];
ub = [-2.25;1];
int = interval(lb,ub);
params.U = zonotope(int);
params.R0 = R0;                                    % initial set
params.tFinal = 350;                               % final time
...
subplot(2,1,1);
hold on;
plotOverTime(R1,[1],'FaceColor',[.9 .5 .5,],'EdgeColor','none');
plotOverTime(R2,[1],'FaceColor',[.5 .5 .5],'EdgeColor','none');
plotOverTime(R3,[1],'FaceColor',[.9 .9 .5],'EdgeColor','none');
plotOverTime(R4,[1],'FaceColor',[.3 .3 .5],'EdgeColor','none');
title('x')
hold off;
subplot(2,1,2);
plotOverTime(R1,[2],'FaceColor',[.9 .5 .5,],'EdgeColor','none');
plotOverTime(R2,[2],'FaceColor',[.5 .5 .5],'EdgeColor','none');
plotOverTime(R3,[2],'FaceColor',[.9 .9 .5],'EdgeColor','none');
plotOverTime(R4,[2],'FaceColor',[.3 .3 .5],'EdgeColor','none');
V = [288 278 378 398; 
    0 19372 19372 0];
poly = mptPolytope(V'); 
plot(poly);
...
hold on;
subplot(2,1,2);
plotOverTime(R1,[6],'FaceColor',[.9 .5 .5,],'EdgeColor','none');
plotOverTime(R2,[6],'FaceColor',[.5 .5 .5]);
plotOverTime(R3,[6],'FaceColor',[.9 .9 .5],'EdgeColor','none');
plotOverTime(R4,[6],'FaceColor',[.3 .3 .5],'EdgeColor','none');
title('$\dot{\theta}$','Interpreter','latex')
hold off;
subplot(2,1,1);
plotOverTime(R1,[3],'FaceColor',[.9 .5 .5,],'EdgeColor','none');
plotOverTime(R2,[3],'FaceColor',[.5 .5 .5],'EdgeColor','none');
plotOverTime(R3,[3],'FaceColor',[.9 .9 .5],'EdgeColor','none');
plotOverTime(R4,[3],'FaceColor',[.3 .3 .5],'EdgeColor','none');
title('\theta')

figure;
hold on;
plotOverTime(R1,[7],'FaceColor',[.9 .5 .5,],'EdgeColor','none');
plotOverTime(R2,[7],'FaceColor',[.5 .5 .5],'EdgeColor','none');
plotOverTime(R3,[7],'FaceColor',[.9 .9 .5],'EdgeColor','none');
plotOverTime(R4,[7],'FaceColor',[.3 .3 .5],'EdgeColor','none');
title('m(t)')
hold off;
...
hold on;
subplot(2,1,2);
plotOverTime(R1,[5],'FaceColor',[.9 .5 .5,],'EdgeColor','none');
plotOverTime(R2,[5],'FaceColor',[.5 .5 .5],'EdgeColor','none');
plotOverTime(R3,[5],'FaceColor',[.9 .9 .5],'EdgeColor','none');
plotOverTime(R4,[5],'FaceColor',[.3 .3 .5],'EdgeColor','none');
title('vy')
hold off;
subplot(2,1,1);
plotOverTime(R1,[4],'FaceColor',[.9 .5 .5,],'EdgeColor','none');
plotOverTime(R2,[4],'FaceColor',[.5 .5 .5],'EdgeColor','none');
plotOverTime(R3,[4],'FaceColor',[.9 .9 .5],'EdgeColor','none');
plotOverTime(R4,[4],'FaceColor',[.3 .3 .5],'EdgeColor','none');
title('vx')
