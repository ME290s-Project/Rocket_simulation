...
def MPC_land():
    ...
    DT = 1 # time interval 
    N = 50 # number of total intervals 
    INITIAL_STATE = [257226, 21731, -1, 200, -560, 0, 354696]
    # INITIAL_STATE = [279734, 22564, -1, 200, -560, 0, 326956]
    DESIRED_STATE=  [270000, 0, 0,  0,0,0, 3.5e5]
    P = [1e-5, 1e-3,10,1e-2,1e-2,1, 1e-5]  # P matrix for terminal state cost 
